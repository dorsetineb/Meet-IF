    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4" aria-modal="true" role="dialog">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-5 border-b">
            <h2 className="text-xl font-bold text-gray-800">Definir Horário de Almoço</h2>
        ...
        <div className="p-6 space-y-6">
            <div className="grid grid-cols-2 gap-4">
                 <div>
                    <label htmlFor="lunchStartTime" className="block text-sm font-medium text-gray-700">Início do Almoço</label>
                    <input
                        type="time"
                        id="lunchStartTime"
                 ...
                 <div>
                    <label htmlFor="lunchEndTime" className="block text-sm font-medium text-gray-700">Fim do Almoço</label>
                    <input
                        type="time"
                        id="lunchEndTime"
                        value={localEndTime}
        ...
        <div className="flex justify-between items-center p-5 border-t bg-gray-50 rounded-b-xl">
            <button onClick={handleRemove} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-red-600 bg-white border border-red-300 rounded-md hover:bg-red-50">
